    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                {
                    color.r = color.r * color.a + blendColor.r * (1.0 - color.a);
                    color.g = color.g * color.a + blendColor.g * (1.0 - color.a);
                    color.b = color.b * color.a + blendColor.b * (1.0 - color.a);
                    
                    if(blendColor.a > color.a)
                    {
