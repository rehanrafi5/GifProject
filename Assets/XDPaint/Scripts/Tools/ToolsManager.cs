	...
	public class ToolsManager
	{
		...
		public ToolsManager()
		{
			AllTools = new[]
			{
				...
				new KeyValuePair<PaintTool, BasePaintTool>(PaintTool.Object, new ObjectTool()),
				new KeyValuePair<PaintTool, BasePaintTool>(PaintTool.Background, new BackgroundTool()),
				new KeyValuePair<PaintTool, BasePaintTool>(PaintTool.Shape, new ShapeTool()),
                new KeyValuePair<PaintTool, BasePaintTool>(PaintTool.Set, new SetTool()),
            };
		...
		public void SetTool(PaintTool newTool)
		{
			...
			if(OnToolUpdated != null)
            {
				OnToolUpdated.Invoke();
			}
		}
